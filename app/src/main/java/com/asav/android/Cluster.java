...
public class Cluster {
    ...
    private final float threashold = 0.75f;
    private String TAG = "CLUSTER";
...
//                centers.set(min_idx, new Pair<Integer, float[]>(id, new_center));
                ...
                counters.add(1);
                Log.i(TAG, "OPA1 : " + centers.size());
                centers.add(new Pair<>(centers.size(), norm_vec_));
                Log.i(TAG, "OPA12 : " + centers.size());
